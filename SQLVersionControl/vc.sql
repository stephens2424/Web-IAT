...
INSERT INTO `stimuli` VALUES (406,14,'Rainbow test',NULL,16),(424,14,'new word',NULL,16),(423,14,'new word',NULL,16);
...
CREATE TABLE `stimulusCategories` (
  ...
  `pairedCategory` int(11) DEFAULT NULL,
  `associatedCategory` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2011-07-13 19:54:53
